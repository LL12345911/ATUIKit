...
#pragma mark - set
- (void)setStyle:(ATCustomButtonStyle)style {
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect {
    ...
    switch (_style) {
        ...
        case ATCustomButtonStyleBottom:{
