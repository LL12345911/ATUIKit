...
- (UIImage *)at_drawingWithDilateIterations:(int)iterations{
    ...
    for (int i=0; i<iterations; i++) {
        dstImage = [dstImage at_drawingWithDilate];
    }
    return dstImage;
}
...
- (UIImage *)at_drawingWithErodeIterations:(int)iterations{
    UIImage *dstImage = self;
    for (int i=0; i<iterations; i++) {
        dstImage = [dstImage at_drawingWithErode];
    }
    return dstImage;
}

- (UIImage *)at_drawingWithGradientIterations:(int)iterations{
    UIImage *dilated = [self at_drawingWithDilateIterations:iterations];
    UIImage *eroded = [self at_drawingWithErodeIterations:iterations];
    UIImage *dstImage = [dilated at_imageBlendedWithImage:eroded blendMode:kCGBlendModeDifference alpha:1.0];
    return dstImage;
}

- (UIImage *)at_drawingWithTophatIterations:(int)iterations {
    UIImage *dilated = [self at_drawingWithDilateIterations:iterations];
    UIImage *dstImage = [self at_imageBlendedWithImage:dilated blendMode:kCGBlendModeDifference alpha:1.0];
    return dstImage;
}

- (UIImage *)at_drawingWithBlackhatIterations:(int)iterations {
    UIImage *eroded = [self at_drawingWithErodeIterations:iterations];
    UIImage *dstImage = [eroded at_imageBlendedWithImage:self blendMode:kCGBlendModeDifference alpha:1.0];
    return dstImage;
}
...
#pragma mark - 复用函数
// 混合函数
- (UIImage *)at_imageBlendedWithImage:(UIImage *)overlayImage
